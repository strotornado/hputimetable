 ...
 */
public class WhiteBgAppWidget extends AppWidgetProvider {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (intent.getAction().equals(UPDATE_APPWIDGET)||intent.getAction().equals(UPDATE_ACTION) || intent.getAction().equals(Intent.ACTION_TIME_CHANGED)) {
            ...
            ComponentName cn = new ComponentName(context, WhiteBgAppWidget.class);
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent serviceIntent = new Intent(context, WhiteBgService.class);
